...
class FirmataDevice:BluetoothDevice,FirmataDelegate {
    ...
    override internal func peripheral(_ peri: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: NSError?) {
    ...
    //MARK: receive Data
    override internal func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic, error: NSError?) {
