...
open class CentralManager : NSObject, CBCentralManagerDelegate, CMWrapper {
    ...
    open class var sharedInstance : CentralManager {
        self.instance = self.instance ?? CentralManager()
        return self.instance
    }

    open class func sharedInstance(_ options:[String:AnyObject]) -> CentralManager {
